...
let ApiService = class ApiService {
    ...
    constructor(http) {
        ...
        this.apiURL = 'https://my-json-server.typicode.com/victorrosendo/repoUsuariosRamos';
        this.apiURLsec = 'https://my-json-server.typicode.com/victorrosendo/repoSeccionAsigSeccion';
    }
    getUsuario() { return this.http.get(this.apiURL + '/users/').pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_1__.retry)(3)); }
    getRamos() {
        return this.http.get(this.apiURL + '/ramos/').pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_1__.retry)(3));
    }
    getSeccion() {
        return this.http.get(this.apiURLsec + '/seccion/').pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_1__.retry)(3));
    }
    getAsigsecci() {
        return this.http.get(this.apiURLsec + '/asigsecci/').pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_1__.retry)(3));
    }
};
...
const attachComponent = /*#__PURE__*/function () {
  var _ref = (0,C_Users_enzom_OneDrive_Documentos_GitHub_xd_Asisterin_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (delegate, container, component, cssClasses, componentProps, inline) {
    var _a;
...
const CoreDelegate = () => {
  ...
  const attachViewToDom = /*#__PURE__*/function () {
    var _ref2 = (0,C_Users_enzom_OneDrive_Documentos_GitHub_xd_Asisterin_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (parentElement, userComponent, userComponentProps = {}, cssClasses = []) {
      var _a, _b;
...
const getScrollElement = /*#__PURE__*/function () {
  var _ref = (0,C_Users_enzom_OneDrive_Documentos_GitHub_xd_Asisterin_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (el) {
    if (isIonContent(el)) {
      yield new Promise(resolve => (0,_helpers_3b390e48_js__WEBPACK_IMPORTED_MODULE_1__.c)(el, resolve));
